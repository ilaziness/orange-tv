...
export const adminApi = {
  ...
  profile: () =>
    withAuth((token) => apiGet<AdminProfile>(ADMIN_API_BASE, '/auth/profile', { token })),
  ...
  listCategories: () =>
    withAuth((token) => apiGet<Category[]>(ADMIN_API_BASE, '/categories', { token })),
  createCategory: (body: unknown) =>
    withAuth((token) => apiPost(ADMIN_API_BASE, '/categories', body, { token })),
  updateCategory: (id: number, body: unknown) =>
    withAuth((token) => apiPut(ADMIN_API_BASE, `/categories/${id}`, body, { token })),
  deleteCategory: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/categories/${id}`, { token })),

  listVideos: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<VideoListItem>>(ADMIN_API_BASE, '/videos', { token, query }),
    ),
  getVideo: (id: number) =>
    withAuth((token) => apiGet<VideoDetail>(ADMIN_API_BASE, `/videos/${id}`, { token })),
  createVideo: (body: unknown) =>
    withAuth((token) => apiPost(ADMIN_API_BASE, '/videos', body, { token })),
  updateVideo: (id: number, body: unknown) =>
    withAuth((token) => apiPut(ADMIN_API_BASE, `/videos/${id}`, body, { token })),
  deleteVideo: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/videos/${id}`, { token })),
  ...
  deleteDirector: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/directors/${id}`, { token })),
  ...
  deleteActor: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/actors/${id}`, { token })),
  ...
  createTag: (name: string) =>
    withAuth((token) => apiPost<NamedItem>(ADMIN_API_BASE, '/tags', { name }, { token })),
  updateTag: (id: number, name: string) =>
    withAuth((token) => apiPut<NamedItem>(ADMIN_API_BASE, `/tags/${id}`, { name }, { token })),
  deleteTag: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/tags/${id}`, { token })),
  ...
  deletePlaySource: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/play-sources/${id}`, { token })),
  ...
  deleteEpisode: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/play-episodes/${id}`, { token })),
  ...
  listCollectSources: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<CollectSource>>(ADMIN_API_BASE, '/collect-sources', { token, query }),
    ),
  createCollectSource: (body: unknown) =>
    withAuth((token) =>
      apiPost<CollectSource>(ADMIN_API_BASE, '/collect-sources', body, { token }),
    ),
  updateCollectSource: (id: number, body: unknown) =>
    withAuth((token) =>
      apiPut<CollectSource>(ADMIN_API_BASE, `/collect-sources/${id}`, body, { token }),
    ),
  ...
  getCollectCategories: (id: number) =>
    withAuth((token) =>
      apiGet<CollectCategoryMap[]>(ADMIN_API_BASE, `/collect-sources/${id}/categories`, { token }),
    ),
  setCollectCategories: (id: number, body: unknown) =>
    withAuth((token) =>
      apiPost<CollectCategoryMap[]>(ADMIN_API_BASE, `/collect-sources/${id}/categories`, body, {
        token,
      }),
    ),
  fetchRemoteCategories: (id: number) =>
    withAuth((token) =>
      apiGet<RemoteCategoryResponse>(ADMIN_API_BASE, `/collect-sources/${id}/remote-categories`, {
        token,
      }),
    ),
  enableCollectSchedule: (id: number) =>
    withAuth((token) =>
      apiPost(ADMIN_API_BASE, `/collect-sources/${id}/schedule/enable`, null, { token }),
    ),
  disableCollectSchedule: (id: number) =>
    withAuth((token) =>
      apiPost(ADMIN_API_BASE, `/collect-sources/${id}/schedule/disable`, null, { token }),
    ),
  ...
  listCollectLogs: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<CollectLog>>(ADMIN_API_BASE, '/collect/logs', { token, query }),
    ),

  getSiteSettings: () =>
    withAuth((token) =>
      apiGet<SiteSettings>(ADMIN_API_BASE, '/settings', { token, query: { group: 'site' } }),
    ),
  getAPISettings: () =>
    withAuth((token) =>
  ...
  listAdminLoginLogs: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<AdminLoginLogItem>>(ADMIN_API_BASE, '/admin-login-logs', { token, query }),
    ),
  ...
  dashboard: () =>
    withAuth((token) => apiGet<DashboardData>(ADMIN_API_BASE, '/dashboard', { token })),
  batchUpdatePublishStatus: (ids: number[], status: number) =>
    withAuth((token) =>
      apiPost(ADMIN_API_BASE, '/videos/batch/publish-status', { ids, status }, { token }),
    ),
  ...
  listComments: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<AdminCommentItem>>(ADMIN_API_BASE, '/comments', { token, query }),
    ),
  getCommentParents: (id: number) =>
    withAuth((token) =>
      apiGet<AdminCommentParentItem[]>(ADMIN_API_BASE, `/comments/${id}/parents`, { token }),
    ),
  updateCommentStatus: (id: number, status: number) =>
    withAuth((token) => apiPut(ADMIN_API_BASE, `/comments/${id}/status`, { status }, { token })),
  deleteComment: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/comments/${id}`, { token })),
  ...
  createAdmin: (body: unknown) =>
    withAuth((token) => apiPost(ADMIN_API_BASE, '/admins', body, { token })),
  updateAdmin: (id: number, body: unknown) =>
    withAuth((token) => apiPut(ADMIN_API_BASE, `/admins/${id}`, body, { token })),
  deleteAdmin: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/admins/${id}`, { token })),
  ...
  listGroups: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<UserGroupItem>>(ADMIN_API_BASE, '/groups', { token, query }),
    ),
  createGroup: (body: unknown) =>
    withAuth((token) => apiPost(ADMIN_API_BASE, '/groups', body, { token })),
  updateGroup: (id: number, body: unknown) =>
    withAuth((token) => apiPut(ADMIN_API_BASE, `/groups/${id}`, body, { token })),
  deleteGroup: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/groups/${id}`, { token })),
  ...
  deleteUser: (id: number) =>
    withAuth((token) => apiDelete(ADMIN_API_BASE, `/users/${id}`, { token })),
  ...
  listUserLoginLogs: (query?: Record<string, string | number | undefined>) =>
    withAuth((token) =>
      apiGet<PageData<UserLoginLogItem>>(ADMIN_API_BASE, '/user-login-logs', { token, query }),
    ),
  ...
  createBanner: (body: unknown) =>
    withAuth((token) => apiPost(ADMIN_API_BASE, '/banners', body, { token })),
  ...
  batchUpdatePreview: (body: { target: string; old_value: string }) =>
    withAuth((token) =>
      apiPost<BatchUpdatePreviewResult>(ADMIN_API_BASE, '/data/batch-update/preview', body, {
        token,
      }),
    ),
  batchUpdateExecute: (body: { target: string; old_value: string; new_value: string }) =>
    withAuth((token) =>
      apiPost<BatchUpdateExecuteResult>(ADMIN_API_BASE, '/data/batch-update/execute', body, {
        token,
      }),
    ),
}
