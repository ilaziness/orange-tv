...
function playlistPlugin(option: {
  playlistRef: React.RefObject<PlaylistItem[] | undefined>
  currentEpRef: React.RefObject<number | undefined>
  onChangeRef: React.RefObject<((episodeId: number) => void) | undefined>
