...
const docTemplate = `{
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "list": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/admin.MediaAsset"
                                                            }
                                                        }
                                                    }
                                                }
                ...
                "parameters": [
                    {
                        ...
                        "type": "string",
                        "description": "配置分组（site=站点信息，api=API/资源站，feature=功能开关，seo=SEO设置，storage=云存储）",
                        "name": "group",
                        "in": "query",
                        "required": true
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/admin.StoragePingResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/client.UploadMediaResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "description": "配置分组（site=站点信息，feature=功能开关，seo=SEO公开字段），可传多个",
                        "name": "groups",
                        "in": "query",
                        "required": true
                    }
        ...
        "/sitemaps/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "形如 videos-1.xml；分页序号从 1 开始",
                        "name": "name",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "admin.UpdateSettingsRequest": {
            ...
            "properties": {
                "data": {
                    "description": "分组配置键值 JSON 数据（结构随分组变化）"
                },
                "group": {
                    "description": "配置分组（必填：site=站点信息，api=API/资源站，feature=功能开关，seo=SEO设置，storage=云存储）",
                    "type": "string",
                    "enum": [
                        "site",
                        "api",
