...
- `internal/handler/http/open/` - 开放 API 处理器
...
- `internal/service/admin`、`internal/service/client`、`internal/service/open` - 业务逻辑
...
- `internal/service/`（含 `admin/`、`client/`、`open/`）- 业务逻辑层
