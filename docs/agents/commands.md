...
生成文件后缀为 `.gen.go`，文件开头包含 `// Code generated by orange-tv gen model. DO NOT EDIT.` 注释。含 `created_at`/`updated_at` 字段的模型自动生成 `BeforeAppendModelHook`，Insert 时设 `created_at`/`updated_at`，Update 时设 `updated_at`，无需在 Repository 层手动赋值。
