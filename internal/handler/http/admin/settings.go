...
// GetSettings
// @Summary 获取系统设置
// @Description 按分组获取系统设置。data 结构随 group 变化：site=SiteSettings，api=APISettings，feature=FeatureMatrix，seo=SEOSettings，storage=StorageSettings，payment=PaymentSettings
// @Tags 管理端｜系统设置
// @Accept json
// @Produce json
// @Security BearerAuth
...
// UpdateSettings
// @Summary 更新系统设置
// @Description 按分组更新系统设置，data 为对应分组的 key-value JSON（site/api/feature/seo/storage/payment），返回更新后的设置结构
// @Tags 管理端｜系统设置
// @Accept json
// @Produce json
// @Security BearerAuth
